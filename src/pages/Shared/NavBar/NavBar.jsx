...
const NavBar = () => {
  ...
  const listOptions = (
    <>
      ...
      <li>
        <label className="swap swap-rotate bg-deepred">
          <input
            type="checkbox"
          ...
          <svg
            className="swap-on fill-current w-7 h-7 text-blue-800"
          ...
          <svg
            className="swap-off fill-current w-7 h-7 text-blue-800"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
  ...
  return (
    <div className="navbar rounded-lg fixed z-10 bg-opacity-30 max-w-screen-xl bg-black text-white">
