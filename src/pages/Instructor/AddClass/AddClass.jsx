...
const AddClass = () => {
  ...
  const onSubmit = (data) => {
    ...
    .then(imgResponse=>{
        ...
        const newData={name,image:imgURL,instructorEmail:email,price:parseFloat(price),availableSeats:parseFloat(availableSeats),instructor,enrolled:0,status:'pending',feedback:''}
        axiosSecure.post("/classes", newData).then((data) => {
           if (data.data.insertedId) {
            ...
            Swal.fire({
                position: 'top-center',
                icon: 'success',
                title:"Course submitted successfully!!wait for approval or feedback",
